...
\thesistitle{Exploration of Artifical Intelligence Technics for the Construction of Conversational Agents} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
% \thesistitle{Statistical learning models to determine Employee Engagement in the workplace} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
% \end{titlepage}
%
% Title page is imported from 'title.pdf' page
...
Conversational agents (chatbots) have increased in popularity for the past 2 years. Businesses have a new way of communicating with their customers but must face challenges.
...
The different experiments aim at understanding the state of the art of chabot models and aim also at providing information on what is today feasible.
...
However, Cornell Movie Dialogs corpus, the dataset used for the experiment, is between 1\% and 10\% the size of other datasets used to train more robust chatbots.
Besides from the dataset, some parameters create better models. For example, a model with two hidden layers performs better that a model with four or eight hidden layers.
