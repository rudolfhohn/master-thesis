...
\thesistitle{Exploration of Artifical Intelligence Technics for Conversational Agents} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
% Employee Engagement is becoming a priority for managers. They understand that engaged collaborators are motivated in their work, enjoy their work and are absorbed by their work, which leads to better overall performance for the company and a higher customer satisfaction. In the context of industry 4.0, answering surveys is not enough to measure effectively the engagement and to boost it. This project shows that it is possible to overcome this limitation and to detect if one is the engagement level with the technics used in Sentiment Analysis. However, further work is required to create a model with a bigger dataset and more complex, for instance with deep neural networks.
%
% \end{abstract}
%
% %----------------------------------------------------------------------------------------
...
% \textbf{LSTM} & \textbf{W}hat (it) \textbf{S}tands \textbf{F}or\\
%
% \end{abbreviations}
